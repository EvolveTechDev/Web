...
<body>
	...
	<section id="headImg" style="overflow: hidden;">
		...
		<img src="{{asset('img/u3.jpg')}}" style="filter: brightness(60%);">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('index')}}">Inicio</a>
						</li>
						...
						<div class="card-content table-responsive">
							...
							<section id="detalles">
								<div id="app-Tienda">
									<div class="contact-form">
										<form role="form" method="post" action="{{route('Cotizacion.storeWebCorporativa2')}}">
								...
								<div id="app-Web">
									<div class="contact-form">
										<form role="form" method="post" action="{{route('Cotizacion.storeTiendaOnline2')}}">
                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
											<div class="form-group">
											...
											<div class="form-group">
												<label for="opcion3">Gestión de forma de pago</label>
								...
								<div id="app-Desarrollo">
									<div class="contact-form">
										<form role="form" method="post" action="{{route('Cotizacion.storeDesarrolloPersonalizado2')}}">
                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
											<label>
							...
							<section id="contacto">
								...
								<div class="contact-form">
									...
									<form role="form" id="ender" method="post" action="{{route('Cotizacion.storeDesarrolloPersonalizado2')}}">
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" name="lastname" placeholder="Pérez" required="true"></input>
										</div>
										<div class="form-group">
											<label for="documento">Ingrese su Documento de identidad o razón social:</label>
											<input class="form-control" type="text" name="documento" placeholder="V22345678 o J123456789" required="true"></input>
										</div>
										<div class="form-group">
											<label for="telefono">Ingrese su teléfono:</label>
											<input class="form-control" type="text" name="telefono" placeholder="0424-5555555" required="true"></input>
										</div>
										<div class="form-group">
											<label for="email">Ingrese su e-mail:</label>
											<input class="form-control" type="email" name="email" placeholder="example@servicio.com" required="true"></input>
										</div>
										<div class="form-group">
											<label for="option">¿De dónde nos escribes?</label>
											<input class="form-control" type="text" id="pais" placeholder="Pais" required name="pais">
										</div>
										<div class="form-group">
											<label for="password">Contraseña</label>
											<input class="form-control" type="password" id="password1" placeholder="Ingresa tu contraseña" required name="true">
										</div>
										<div class="form-group">
											<label for="password">Confirma tu Contraseña</label>
											<input class="form-control" type="password" id="password2" placeholder="Vuelve a ingresar tu contraseña" required name="true">
										</div>
