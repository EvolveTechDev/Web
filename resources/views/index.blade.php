...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('v.js/v.css')}}">
...
<body>
	...
	<section id="cover">
		<img src="{{asset('img/1366.png')}}" style="position:absolute;top:0;left:0;width: 100vw;height: 100vh;">
		...
		<img src="{{asset('img/b.png')}}" id="e" style="display: none;z-index: 50" onload="animatrix()">
		<div id="volveContainer" style="z-index: 50">
			<img src="{{asset('img/revolver.png')}}" id="volve" style="display: none" onload="animatrix()">
		</div>
		<div
			id="ko"
			style="
	...
	<section id="fc" style="background-image: url({{URL::asset('img/s2.png')}});background-attachment: fixed;">
		...
		<div>
			<img src="{{asset('img/iphone.png')}}" class="j-animate">
	...
	<section id="servicios" style="padding-top: 1.5em">
		...
		<section id="cards">
			<a class="j-animate org-left" href="Web-corporativa">
				<img src="{{asset('img/servidef1.png')}}">
				<section>
			...
			<a class="org-center" href="Tienda-virtual">
				<img src="{{asset('img/servidef2.png')}}">
				<section>
			...
			<a class="j-animate org-right" href="Personalizado">
				<img src="{{asset('img/servidef3.png')}}">
				<section>
	...
	<!-- SECCION COMO LO HACEMOS (COHETE) -->
	<script>
		if(window.innerWidth*.9 > window.innerHeight)
			document.write(`<div id="sparent">
					<div id="scroll-container">
						<div id="real-inverter">
							<div style="top:5%" ><img id="moon" src="{{asset('img/ship/1.png')}}"></div>
							<div id="satelite" style="top:25%"><img src="{{asset('img/ship/5.png')}}"></div>
							<div id="plane" style="top:45%"><img src="{{asset('img/ship/2.png')}}"></div>
							<div id="cloud" style="top:70%"><img src="{{asset('img/ship/4.png')}}"></div>
							<div id="floor" style="top:100%;"><img src="{{asset('img/ship/3.png')}}"></div>
						</div>
						<div id="inverter"></div>
					</div>
					<div id="rocket">
		...
		document.addEventListener('DOMContentLoaded',function(){
			...
			cont.addEventListener('scroll',function(e) {
				let containerSize = window.innerHeight*0.6
					elementSize = window.innerHeight*3
	...
	<style>
		#cohete,#llama{left:50vw;position:absolute}
		#cohete,#llama,#real-inverter{position:absolute}
		body,html{width:100%;margin:0;padding:0}
		@media(max-width:700px){
			#sparent{display:none}
		}
		#sparent{margin-top:0;position:relative;overflow:hidden;height:60vh}
		#cohete{top:8%;transform:translateX(-50%) scaleX(.85);height:75%;z-index:4}
		#llama{top:0;transform:translateX(-52%) scale(.9);height:100%}
		#scroll-container{height:60vh;width:100vw;overflow-y:auto}
		#inverter{width:100%;height:300vh;opacity:.01}
		#real-inverter{width:100%;height:300vh;background:linear-gradient(black,#001a44,#001a44,#1a3663,#1a3663,#0086ce,#0086ce 93%,#fff 99%);opacity:1;transform:translateY(-100%)}
		#real-inverter div{
			z-index:4;
			position:absolute;
		...
		#real-inverter div:hover{background-color:red;box-shadow:0 0 10px #fff}
		#real-inverter div:nth-child(even){left:25%}
		#real-inverter div:nth-child(odd){left:75%}
		#real-inverter>img{width:110vw;height:auto;top:100%;transform:translate(-50%,-100%)}
		#real-inverter div#floor{
			width:15%;
		}
		#real-inverter div#plane{
			width:100%;
			left: 0;
			transform: none;
		...
		#real-inverter div#floor img{
			transform:translate(0%,-100%);
		}
		#real-inverter div#cloud{
			width:40%;
		}
		#real-inverter div#satelite{
			width:37%;
		}
		#real-inverter div img{
			width: 100%;
		...
		#moon{
			border-radius: 50%;
			box-shadow: 5px 5px 150px white,-5px -5px 150px white,0 0 150px white;
		}
	</style>

	<!-- FIN SECCION COMO LO HACEMOS (COHETE) -->
	<section id="idea">
		...
		<div id="ideac">
			<img id="bg">
			<img src="{{asset('img/amarillo.png')}}" id="yll">
			<img src="{{asset('img/party.png')}}" id="party">
		</div>
		<ul>
		...
		<script type="text/javascript">
			...
			let crocker = function() {
				if (window.innerWidth > 1000) {
					ft.src = "{{asset('img/alt.png')}}"
				}else{
					ft.src = "{{asset('img/ft.png')}}"
				}
			}
			crocker()
...
<section id="contact">
		<div class="container-fluid">
			<div class="row" style="margin-top: 30px;">
				<div class="col-md-5 col-lg-3">
					<section style="border: 2px solid #eee;margin-bottom: 15px; padding: 10px; background-color: rgba(0,0,0,.65);color: white;">
						<address>
				...
				<div id="asa" class="container" style="border-radius: 0.5em 0.5em;background-color: rgba(0,0,0,.25); padding: 5px;">
	...
	<script type="text/javascript" src="{{asset('js/v.js')}}"></script>
</body>
</html>