...
<head>
	...
	<style type="text/css">
		#duplex li {  
			background: url({{URL::asset('img/qw.png')}}) top left no-repeat; 
			background-size: 3%;
...
<body>
	...
	<section id="headImg" style="overflow: hidden;">
		...
		<img src="{{asset('img/stripes.png')}}">
		<div id="s" class="j-animate title" style="top: 30%;left: 40%;font-size: 3.5em">E-commerce.</div>
		<div
			id="alt"
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Tienda virtual</li>
	...
	<div id="white" style="position: relative;overflow: hidden">
		<h1 class="title" style="font-size: 2.5em" > Ofrece tus productos o servicios en internet.</h1>
		
		
		<section id="duplex">
			<div class="j-animate j-right" style="text-align: center;">
				<h2 class="title" style="font-size: 1.5em; margin-top: 7px; margin-bottom: 7px;">Tienda Online.</h2>
				<h2  style="font-size: 1.2em;  margin-top: 7px; margin-bottom: 7px;">Si necesitas Vender algo estas en el sitio correcto.</h2>
				<h2  style="font-size: 1.5em;  margin-top: 7px; margin-bottom: 7px;">desde 420$</h2>
				<ul style="font-size: 1.4em;text-align: left;margin-bottom: 1.5em;">
					...
					<li>Estrategica digital básica</li>
					<li>Sistema de catalogos (Categoria y subcategoria)</li>
					<li>Carrito de compra</li>
					<li>Gestión de diferentes formas de pago</li>
					<li>Configuración de los gastos de envío</li>
					<li>Configuración de los impuestos</li>
					
					<li>informes de inventario</li>
					<li>Generación de facturas automáticas en PDF</li>
					<li>Creación de cuentas de cliente</li>
					<li>Multidivisa</li>
					<li>Exportación a contabilidad</li>
			...
			<div style="text-align: center; ">
				<img style="width: 60%" src="{{asset('img/tienda.png')}}" class="j-animate">
			</div>
		</section>
		...
		<section style="margin-top: 50px" id="howDoWe">
			...
			<section>
				<div style="margin-top: 20px;border-left: 1px solid #ddd;padding: 1em;">
					<figure>
						<img style="width: 40%;"" src="{{asset('img/sen.png')}}">
				...
				<div style="margin-top: 20px;border-left: 1px solid #ddd;padding: 1em;">
					<figure>
						<img style="width: 40%;"" src="{{asset('img/cont.png')}}">
				...
				<div style="margin-top: 20px;border-left: 1px solid #ddd;padding: 1em;">
					<figure>
						<img style="width: 40%;"" src="{{asset('img/anal.png')}}">
				...
				<div style="margin-top: 20px;border-left: 1px solid #ddd;padding: 1em;">
					<figure>
						<img style="width: 40%;"" src="{{asset('img/cali.png')}}">
