...
<body>
	...
	<section id="headImg" style="overflow: hidden;">
		...
		<div id="s" class="j-animate title" style="top: 30%;left: 40%;font-size: 3.5em">Diseño Personalizado.</div>
		<div
			id="alt"
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Desarrollo personalizado</li>
</ol>
          </div>
        </div>
      </div>
	...
	<div id="white" style="position: relative;overflow: hidden">
		<h1 class="title" style="font-size: 2.5em" > Desarrollo adaptado a tus necesidades.</h1>
		
		<section id="duplex">
			<div class="j-animate j-right" style="text-align: center;">
				<h2 class="title" style="font-size: 1.5em; margin-top: 7px; margin-bottom: 7px;">¿Tienes Alguna idea única y diferente?</h2>
				<h2  style="font-size: 1.5em;  margin-top: 7px; margin-bottom: 7px;">Trabajemos juntos y hagámosla ¡REALIDAD!</h2>
				
				<ul style="font-size: 1.4em;text-align: left;margin-bottom: 1.5em;">
					<li>Todas las herramientas conocidas a tu disposición.</li>
					<li>Creación desde cero.</li>
					<li>Sistema Autogestionable</li>
					<li>Tu idea hecha realidad.</li>
			...
			<div style="text-align: center; ">
				<img style="width: 40%; margin-top: 50px;" src="{{asset('img/personalizado.png')}}" class="j-animate">
			</div>
		</section>
