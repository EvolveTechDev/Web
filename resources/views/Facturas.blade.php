                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            ...
                            <div class="form-group">
                                <form role="form" method="get" action="{{route('facturas.tags.index')}}">
                                    ...
                                    <table class="table table-hover table-responsive table-striped">
                                        ...
                                        <!--DINAMICO!-->
                                             ...
                                             <!--<tr onclick="location='upgrade'">-->
                                                <tr >
                                                <td ><a href="{{route('upgrade',$factura->F_id)}}">{{ $factura->C_id }}</a> </td>
                                                <td>{{ $factura->estatus }}</td>
                                                <td>{{ $factura->name }} {{ $factura->apellido }}</td>
                                                <td>{{ $factura->linkfacturas }}</td>
                                                <td>{{ $factura->linkterminos }}</td>
                                            </tr>
                                             @endforeach
                                        <!--
                                            <tr onclick="location='upgrade'">
