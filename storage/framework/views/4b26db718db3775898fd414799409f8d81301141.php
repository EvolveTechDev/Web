...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/v.css')); ?>">
...
<body>
	<header id="heading" class='top'>
		...
		<ul id="deployMenu">
			<li>
				<a class="innerLink" href="<?php echo e(route('index')); ?>">
					Inicio
				</a>
			</li>
			<li>
...
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="<?php echo e(route('index')); ?>">Inicio</a></li>
	...
	<div id="white" style="position: relative;overflow: hidden">
		...
		<section id="duplex">
			...
			<div style="text-align: center; ">
				<img style="width: 60%" src="<?php echo e(asset('img/tienda.png')); ?>" class="j-animate">
			</div>
		</section>
