		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo e(route('index')); ?>">Inicio</a>
						</li>
							...
							<section id="detalles">
								<div id="app-Tienda">
									<div class="contact-form">
										<form role="form" method="post" action="<?php echo e(route('Cotizacion.storeWebCorporativa2')); ?>">
								...
								<div id="app-Web">
									<div class="contact-form">
										<form role="form" method="post" action="<?php echo e(route('Cotizacion.storeTiendaOnline2')); ?>">
                                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
											<div class="form-group">
