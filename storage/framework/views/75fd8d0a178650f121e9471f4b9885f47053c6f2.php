                   ...
                   <!--TAbla de proyectos-->
                    <div class="row">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" id="text" placeholder="Buscar usuarios" required="" name="buscar">
                        </div>
                            <div class="card">
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table table-hover table-responsive table-striped">
                                        ...
                                        foreach($ussers as $usser)  
                                            <tr>
                                                <td><?php echo e($usser->name); ?></td>
                                                <td><?php echo e($usser->apellido); ?></td>
                                                <td><?php echo e($usser->cedula); ?></td>
                                                <td><?php echo e($usser->pais); ?></td>
                                                <td><?php echo e($usser->email); ?></td>
...
<script src="<?php echo e(asset('/js/add-chat.js')); ?>"></script>
