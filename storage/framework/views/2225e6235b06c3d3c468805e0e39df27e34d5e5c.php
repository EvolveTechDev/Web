                        ...
                        <div class="card card-nav-tabs">
                            <!--DINAMICO!-->
                                <div class="card-header" data-background-color="blue">
                                    <?php $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    Cotizacion Nro <?php echo e($cot->C_id); ?>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="profile">
                                            <table class="table" style="min-height:150px;margin-bottom: 20px;">
                                                <tbody>
                                                   <tr>
                                                    <?php $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $co): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td>
                                                        Fecha de Solicitud: <?php echo e($co->fecha_s); ?>

                                                    </td>
                                                    <td>
                                                        Fecha de Caducidad: <?php echo e($co->fecha_c); ?>

                                                    </td>
                                                   </tr>
                                                   <tr>
                                                    <td>
                                                        Categoria: <?php echo e($co->categoria); ?>

                                                    </td>
                                                    <td>
                                                        Status: <?php echo e($co->estatus); ?>

                                                    </td>
                                                   </tr>
                                                   <tr>
                                                    <td>
                                                        Cliente: <?php echo e($co->name); ?> <?php echo e($co->apellido); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <?php $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <button class="btn btn-outlined btn-danger" > <a href="<?php echo e(route('cotizacion.destroy',$cot->C_id)); ?>">Estoy Seguro</a></button>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="myModalagree" class="modal fade in">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-group">
                    a<button class="btn btn-outlined btn-success" > <a href="<?php echo e(route('factura.store',$cot->C_id)); ?>">Comenzar Ahora!</a></button>
