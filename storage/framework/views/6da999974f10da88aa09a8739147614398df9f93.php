...
<body>
	<header id="heading" class='top'>
		...
		<ul id="deployMenu">
			...
			<li class="pdrop">
				...
				<ul class="drop">
					<li><a href="<?php echo e(route('Tienda-virtual')); ?>">Tienda Virtual</a></li>
					<li><a href="<?php echo e(route('Web-corporativa')); ?>">Web Corporativa</a></li>
					<li><a href="<?php echo e(route('Personalizado')); ?>">Personalizado</a></li>
				</ul>
			</li>
			<li>
				<a class="innerLink" href="<?php echo e(route('index')); ?>">
	...
	<div id="main-wrapper" class="wrapper">
		<div class="container">
			...
			<form  method="post" id="form" action="<?php echo e(route('password.reset')); ?>" >
				<?php echo csrf_field(); ?>
				...
				<div class="input-inform">
					...
					<?php if($errors->has('token')): ?>
                     <span class="help-block"><strong><?php echo e($errors->first('token')); ?></strong></span><br>
                	<?php endif; ?>
				...
				<div class="enter">
					...
					<input type="submit" name="submit" value="Restablecer Contraseña" id="enter"/>
				</div>
			</form>    
		</div>
	</div>
