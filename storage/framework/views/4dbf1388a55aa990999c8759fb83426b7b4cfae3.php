        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                   ...
                   <!--Menu principal de facturas-->
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            <!-- BARRA BUSCAR -->
                            <div class="form-group">
                                <form role="form" method="get" action="<?php echo e(route('facturas.tags.index')); ?>">
                            ...
                            <div class="card"> 
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Tus Facturas</h4>
                                </div>
                                <div class="card-content table-responsive">
                                    <table class="table table-hover table-responsive table-striped">
                                        ...
                                        <!--DINAMICO!-->
                                             ...
                                             <!--<tr onclick="location='upgrade'">-->
                                                <tr >
                                                <td ><a href="<?php echo e(route('upgrade',$factura->F_id)); ?>"><?php echo e($factura->C_id); ?></a> </td>
                                                <td><?php echo e($factura->estatus); ?></td>
                                                <td><?php echo e($factura->name); ?> <?php echo e($factura->apellido); ?></td>
                                                <td><?php echo e($factura->linkfacturas); ?></td>
                                                <td><?php echo e($factura->linkterminos); ?></td>
                                            </tr>
