            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="contact-form">
                                    ...
                                    <form role="form" id="ender" method="post" action="<?php echo e(route('update',auth()->user()->id)); ?>">
                                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                        <div class="form-group">
                                            <label for="name">Nombre</label>
                                            <input class="form-control" type="text" name="name" value="<?php echo e(auth()->user()->name); ?>" required="true"></input>
                                        </div>
                                        <div class="form-group">
                                            <label for="lastname">Apellido</label>
                                            <input class="form-control" type="text" name="apellido" value="<?php echo e(auth()->user()->apellido); ?>"  required="true"></input>
                                        </div>
                                        <div class="form-group">
                                            <label for="documento">Documento de identidad o razón social</label>
                                            <input class="form-control" type="text" name="cedula" value="<?php echo e(auth()->user()->cedula); ?>"  required="true"></input>
                                        </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="email">E-mail</label>
                                            <input class="form-control" type="email" name="email" value="<?php echo e(auth()->user()->email); ?>"  required="true"></input>
                                        </div>
                                        <div class="form-group">
                                            <label for="option">Pais</label>
                                            <input class="form-control" type="text" id="pais" value="<?php echo e(auth()->user()->pais); ?>" required name="pais">
                                        </div>
                                        <div class="form-group">
