                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-12">
                            ...
                            <div class="form-group">
                                <form role="form" method="get" action="<?php echo e(route('cotizaciones.tags.index')); ?>">
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table table-hover table-responsive table-striped">
                                        ...
                                        <!--DINAMICO!-->
                                            ...
                                            <tr>
                                                <td><a href="<?php echo e(route('template',$cotizacion->C_id)); ?>"><?php echo e($cotizacion->C_id); ?></a></td>
                                                <td><?php echo e($cotizacion->fecha_c); ?></td>
                                                <td><?php echo e($cotizacion->fecha_s); ?></td>
                                                <td><?php echo e($cotizacion->precio); ?></td>
                                                <td><?php echo e($cotizacion->moneda); ?></td>
                                                <td><?php echo e($cotizacion->categoria); ?></td>
                                            </tr>
                                                    ...
                                                    <section id="detalles">
                                                        <div id="app-Tienda">
                                                            <div class="contact-form">
                                                                <form role="form" method="post" action="<?php echo e(route('Cotizacion.storeWebCorporativa')); ?>">
                                                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                        ...
                                                        <div id="app-Web">
                                                            <div class="contact-form">
                                                                <form role="form" method="post" action="<?php echo e(route('Cotizacion.storeTiendaOnline')); ?>">
                                                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                        ...
                                                        <div id="app-Desarrollo">
                                                            <div class="contact-form">
                                                                <form role="form" method="post" action="<?php echo e(route('Cotizacion.storeDesarrolloPersonalizado')); ?>">
                                                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                                    <div class="form-group">
                                                                            <label for="opcion6">Moneda?</label>
                                                                            <select class="form-control" name="moneda" id="opcion6">
